                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent2">
                    ...
                    <ul className="navbar-nav mr-auto">
                        ...
                        <li className="nav-item dropdown mega-dropdown active">
                            <a href="/" className="nav-link dropdown-toggle text-uppercase" id="navbarDropdownMenuLink2" data-toggle="dropdown"
          ...
          <span className="sr-only">(current)</span>
                    ...
                    architecto
                        ...
                        <li className="nav-item dropdown mega-dropdown">
                            <a href="/" className="nav-link dropdown-toggle text-uppercase" id="navbarDropdownMenuLink3" data-toggle="dropdown"
                                    ...
                                    <div className="col-md-12 col-xl-4 sub-menu mb-xl-0 mb-4">
                                        ...
                                        <a href="#!" className="view overlay z-depth-1 p-0 mb-2">
                                            <img src="https://mdbootstrap.com/img/Photos/Horizontal/Work/8-col/img%20(37).jpg"
                                                className="img-fluid" alt="First sample pic" />
                                            <div className="mask rgba-white-slight"></div>
                                        </a>
                                        <a className="news-title font-weight-bold pl-0" href="#!">Lorem ipsum dolor sit</a>
                                        <p className="font-small text-uppercase white-text">
                                            <i className="fas fa-clock-o pr-2" aria-hidden="true"></i>July 17, 2017 / <i
                                                className="far fa-comments px-1" aria-hidden="true"></i> 20
              </p>
                                    </div>
                        ...
                        <li className="nav-item dropdown mega-dropdown">
                            <a href="/" className="nav-link dropdown-toggle text-uppercase" id="navbarDropdownMenuLink4" data-toggle="dropdown"
                            ...
                            <div className="dropdown-menu mega-menu v-2 z-depth-1 special-color py-5 px-3"
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-md-6 col-xl-3 sub-menu mb-4 mb-xl-0">
                                        <h6 className="sub-title text-uppercase font-weight-bold white-text">Related</h6>
                                    ...
                                    <div className="col-md-6 col-xl-3 sub-menu mb-md-0 mb-xl-0 mb-4">
                                        ...
                                        <a className="news-title font-weight-bold pl-0" href="#!">Ut labore et dolore magna</a>
                                        <p className="font-small text-uppercase white-text">
                                            <i className="fas fa-clock-o pr-2" aria-hidden="true"></i>July 16, 2017 / <i
                                                className="far fa-comments px-1" aria-hidden="true"></i> 25
              </p>
                                    </div>
                                    <div className="col-md-6 col-xl-3 sub-menu mb-0">
                                        <h6 className="sub-title text-uppercase font-weight-bold white-text">Programming</h6>
